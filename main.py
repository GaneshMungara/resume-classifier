...
def prediction_result(top, aplcnt_name, cv_path, personality_values):
    ...
    result.iconbitmap(r"F:\Mini Projects(AI & DL)\Predicting-personality-using-Resume-main\icon3.ico")
...
def perdict_person():
    ...
    top.iconbitmap(r"F:\Mini Projects(AI & DL)\Predicting-personality-using-Resume-main\icon2.ico")
...
def OpenFile(b4):
    global loc;
    name = filedialog.askopenfilename(initialdir=r"C:\Users\anand\Desktop",
...
if __name__ == "__main__":
    ...
    root.iconbitmap(r"F:\Mini Projects(AI & DL)\Predicting-personality-using-Resume-main\icon.ico")
